...
object GlobalConfSync {
    val globalDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.globalDebug)
    val dataBindingDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.dataBindingDebug)
    val taskDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.taskDebug)
    val ddmDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.ddmDebug)
    val cacheDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.cacheDebug)
    val logDebug = ObservableValueProperty(SettingsManager.settings.debugSettings.logDebug)
